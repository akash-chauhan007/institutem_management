...
// class FormsElements extends React.Component {
    ...
    const handleSubmit = async(e) =>{
        ...
        // if(){
            const statsRef = await db.collection("Teacher").doc("--stats--");
            ...
            db.collection('Teacher').doc(ateenId).set({
                cancel:false,
                id:ateenId,
                Course:brand,
                Name:Name,
                                ...
                                <Row>
                                    ...
                                    <Col md={6}>
                                        ...
                                        <Form.Group controlId="exampleForm.ControlInput1">
                                            ...
                                            <Form.Control type="number" placeholder="Full Time"  name ="mrp1"
                                                value={mrp1} onChange={onChange} required
                                            /><br></br>
                                            <Form.Control type="number" placeholder="Over Time" name ="dprice1"
